// In this section, we will learn automorphic numbers with examples and also
// create Java programs that check whether the number is automorphic or not.
...
// the last two digits of the square represent the number itself. Some other
